...
import { invalidateSetting } from '../utils/settingsCache';
...
export const getSettings = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    if (!settingsMap['flight_margin_percent']) {
      settingsMap['flight_margin_percent'] = '10'; // Default 10%
    }
